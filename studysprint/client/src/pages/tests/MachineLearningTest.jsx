...
const questions = [
  {
    ...
    options: ["Learning with labeled data", "Learning without labeled data", "Reinforcement learning", "Clustering"],
  },
  {
  ...
  },
  {
    ...
    options: ["Model performs poorly on training data", "Model is too simple", "Model performs well on training but poorly on test data", "None of the above"],
  },
  {
    question: "Which library is commonly used in Python for ML?",
    options: ["React", "Flask", "Scikit-learn", "Django"],
  },
  {
    question: "What is the purpose of cross-validation?",
    options: ["To reduce training time", "To evaluate model performance", "To increase bias", "To tune hyperparameters"],
  },
];
    ...
    <div className="min-h-screen bg-gray-100 px-4 py-10 text-center">
      {!started ? (
        <div className="max-w-3xl mx-auto bg-white p-8 rounded-xl shadow">
          <h2 className="text-3xl font-bold mb-4 text-blue-700">🧠 Machine Learning Test Instructions</h2>
