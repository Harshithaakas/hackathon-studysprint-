...
const DataStructuresTest = () => {
  ...
  const questions = [
    {
      question: '1. What data structure uses LIFO order?',
      options: ['Queue', 'Stack', 'Array', 'Tree'],
      answer: 'Stack',
    },
    {
      question: '2. Which data structure is used in recursion?',
      options: ['Queue', 'Array', 'Stack', 'Linked List'],
      answer: 'Stack',
    },
    {
      question: '3. Which of the following has O(1) time complexity for insertion at end?',
      options: ['Array', 'Stack', 'Queue', 'Linked List'],
      answer: 'Stack',
    },
    {
      question: '4. What is the best data structure for implementing a priority queue?',
      options: ['Stack', 'Linked List', 'Heap', 'Queue'],
      answer: 'Heap',
    },
    {
      question: '5. Which traversal method is used in DFS of tree?',
    ...
    <div className="min-h-screen bg-blue-50 p-6 md:p-12">
      {!started ? (
        <div className="max-w-3xl mx-auto bg-white rounded-xl shadow p-8">
          <h2 className="text-3xl font-bold text-blue-800 mb-6 text-center">Data Structures Test Instructions</h2>
...
export default DataStructuresTest;
